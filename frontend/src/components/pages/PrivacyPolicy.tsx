  ...
  return (
    <Flex align='center' px={{ base: 5, md: 20 }}>
      <Stack spacing={8}>
        ...
        <Text>
          食費とカロリーの可視化サービス「ミルミル」（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，
        ...
        <OrderedList spacing={2} px={{ base: 5, md: 20 }}>
          ...
          <ListItem>ユーザーが利用中のサービスの新機能，更新情報，キャンペーン等及び当社が提供する他のサービスの案内のメールを送付するため</ListItem>
        ...
        <OrderedList spacing={5} px={{ base: 5, md: 20 }}>
          <ListItem>
            ...
            <OrderedList spacing={2} mt={3}>
              ...
              <ListItem>公衆衛生の向上または児童の健全な育成の推進のために特に必要がある場合であって，本人の同意を得ることが困難であるとき</ListItem>
              <ListItem>
