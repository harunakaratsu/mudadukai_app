  ...
  return (
    <Flex align="center" px={{ base: 5, md: 20 }}>
      <Stack spacing={8}>
        ...
        <Text>
          この利用規約（以下，「本規約」といいます。）は，食費とカロリーの可視化サービス「ミルミル」（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。
        ...
        <OrderedList spacing={5} px={{ base: 5, md: 20 }}>
          <ListItem>
        ...
        <OrderedList spacing={2} px={{ base: 5, md: 20 }}>
        ...
        <OrderedList spacing={5} px={{ base: 5, md: 20 }}>
          ...
          <ListItem>
            ...
            ユーザーに生じた損害のうち特別な事情から生じた損害（当社またはユーザーが損害発生につき予見し，または予見し得た場合を含みます。）について一切の責任を負いません。
          ...
          <ListItem>
            ...
            <OrderedList spacing={2} mt={3}>
              ...
              <ListItem>
                ...
                かつ、変更の必要性、変更後の内容の相当性その他の変更に係る事情に照らして合理的なものであるとき。
              </ListItem>
            </OrderedList>
          </ListItem>
          <ListItem>
        ...
        <OrderedList spacing={5} px={{ base: 5, md: 20 }} pb={5}>
          <ListItem>
